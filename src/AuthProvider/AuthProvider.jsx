    ...
    useEffect(() => {
        const unSubsCribe = onAuthStateChanged(auth, currentUser => {
            ...
            if (currentUser?.email) {
                ...
                axiosPublic.post('https://adoption-pets-server-site.vercel.app/users', userInfo)
                    .then(res => {
                        console.log('userInfo res',res);
                    })
                axiosSecure.post('https://adoption-pets-server-site.vercel.app/jwt', user)
                    .then(res => {
                ...
                axiosSecure.post('https://adoption-pets-server-site.vercel.app/logout', {})
                    .then(res => {
