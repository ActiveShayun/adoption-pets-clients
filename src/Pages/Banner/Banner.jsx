...
const Banner = () => {
    return (
        <>
            ...
            >
                <SwiperSlide>
                    <div className='relative h-[300px] lg:w-full lg:h-[550px] bg-slide-1 bg-cover bg-center rounded-md z-50'>
                        <div className='z-40 flex items-center text-center justify-center h-full'>
                            <h2 className='text-3xl font-bold text-white'> Find Your Perfect Companion – Adopt a Pet Today!
                ...
                <SwiperSlide>
                    <div className='relative h-[300px] lg:w-full lg:h-[550px] bg-slide-2 bg-cover bg-center rounded-md z-50'>
                        <div className='z-40 flex items-center text-center justify-center h-full'>
                ...
                <SwiperSlide>
                    <div className='relative h-[300px] lg:w-full lg:h-[550px] bg-slide-4 bg-cover bg-center rounded-md z-50'>
                        <div className='z-40 flex items-center text-center   justify-center h-full'>
                            <h2 className='text-3xl font-bold text-white'>
                ...
                <SwiperSlide>
                    <div className='relative h-[300px] lg:w-full lg:h-[550px] bg-slide-5 bg-cover bg-center rounded-md z-50'>
                        <div className='z-40 flex items-center text-center justify-center h-full'>
                            <h2 className='text-3xl font-bold text-white'> 
                ...
                <SwiperSlide>
                    <div className='relative h-[300px] lg:w-full lg:h-[550px] bg-slide-6 bg-cover bg-center rounded-md z-50'>
                        <div className='z-40 flex text-center items-center justify-center h-full'>
                            <h2 className='text-3xl font-bold text-white'>
                ...
                <SwiperSlide>
                    <div className='relative h-[300px] lg:w-full lg:h-[550px] bg-slide-7 bg-cover bg-center rounded-md z-50'>
                        <div className='z-40 flex text-center items-center justify-center h-full'>
                            <h2 className='text-3xl font-bold text-white'>
